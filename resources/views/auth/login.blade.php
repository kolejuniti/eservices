            ...
            <div class="row justify-content-center">
                ...
                <div class="card border border-light-subtle rounded-3 shadow-sm">
                    ...
                    @endif<div class="text-center mb-1">
                        <a href="{{ route('login') }}">
                            <picture>
                                <source srcset="https://ku-storage-object.ap-south-1.linodeobjects.com/eservices/images/logo/logo_eservices.webp" type="image/webp">
                                <img src="https://ku-storage-object.ap-south-1.linodeobjects.com/eservices/images/logo/logo_eservices.png" alt="Logo" class="img-fluid" width="120" height="120">
                            </picture>
                        </a>
                    </div>                    
